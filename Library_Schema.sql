...
('9780380002935', 'To the Lighthouse', 'Virginia Woolf', 'Fiction', 1927, 'Doubleday', 2, 3, 1, 1),
('9780765377066', 'Dune', 'Frank Herbert', 'Science Fiction', 1965, 'Ace Books', 3, 4, 1, 2),
('9780345803507', 'Gone with the Wind', 'Margaret Mitchell', 'Historical Fiction', 1936, 'Vintage Books', 2, 2, 0, 3),
('9780143039958', 'Middlemarch', 'George Eliot', 'Fiction', 1871, 'Penguin Classics', 3, 4, 1, 4),
('9780553418020', 'The Martian', 'Andy Weir', 'Science Fiction', 2011, 'Broadway Books', 5, 5, 0, 5),
('9780060929873', 'One Hundred Years of Solitude', 'Gabriel Garcia Marquez', 'Magical Realism', 1967, 'Harper & Row', 4, 5, 1, 1),
('9780451524932', 'Fahrenheit 451', 'Ray Bradbury', 'Science Fiction', 1953, 'Del Rey Books', 3, 4, 1, 2),
('9780380002934', 'The Metamorphosis', 'Franz Kafka', 'Fiction', 1915, 'Doubleday', 4, 4, 0, 3),
('9780765377068', 'The Time Machine', 'H.G. Wells', 'Science Fiction', 1895, 'Ace Books', 3, 4, 1, 4),
('9780140445863', 'Crime and Punishment', 'Fyodor Dostoevsky', 'Fiction', 1866, 'Penguin Classics', 3, 4, 1, 5),
('9780192835467', 'Pride and Prejudice', 'Jane Austen', 'Fiction', 1813, 'Oxford University Press', 4, 5, 1, 1),
('9780385515043', 'The Da Vinci Code', 'Dan Brown', 'Thriller', 2003, 'Doubleday', 3, 3, 0, 2),
('9780062024028', 'The Hunger Games', 'Suzanne Collins', 'Young Adult', 2008, 'Scholastic', 3, 4, 1, 3),
('9780451524934', 'Moby-Dick', 'Herman Melville', 'Fiction', 1851, 'Signet Classics', 2, 3, 1, 4),
('9780345803509', 'The Hobbit', 'J.R.R. Tolkien', 'Fantasy', 1937, 'Houghton Mifflin', 4, 4, 2, 5),
('9780765377063', 'Brave New World', 'Aldous Huxley', 'Science Fiction', 1932, 'Harper & Brothers', 2, 3, 1, 1),
('9780143039955', 'War and Peace', 'Leo Tolstoy', 'Historical Fiction', 1869, 'Penguin Classics', 3, 4, 2, 2),
('9780553418025', 'The Road', 'Cormac McCarthy', 'Post-Apocalyptic', 2006, 'Vintage Books', 4, 5, 1, 3),
('9780060929875', 'The Lord of the Rings', 'J.R.R. Tolkien', 'Fantasy', 1954, 'Houghton Mifflin', 5, 5, 1, 4),
('9780451524938', 'The Shining', 'Stephen King', 'Horror', 1977, 'Anchor Books', 2, 3, 0, 5),
('9780679764024', 'The Bell Jar', 'Sylvia Plath', 'Fiction', 1963, 'Harper Perennial Modern Classics', 3, 3, 1, 1),
('9780061122411', 'The Hitchhiker''s Guide to the Galaxy', 'Douglas Adams', 'Science Fiction', 1979, 'Del Rey Books', 5, 5, 0, 2),
('9780142000670', 'Life of Pi', 'Yann Martel', 'Adventure', 2001, 'Mariner Books', 4, 4, 1, 3),
('9780060850524', 'The Kite Runner', 'Khaled Hosseini', 'Fiction', 2003, 'Riverhead Books', 3, 3, 0, 4),
('9780767908184', 'The Poisonwood Bible', 'Barbara Kingsolver', 'Fiction', 1998, 'Harper Perennial', 4, 5, 1, 5),
('9781400079270', 'The Girl with the Dragon Tattoo', 'Stieg Larsson', 'Mystery', 2005, 'Vintage Crime/Black Lizard', 5, 5, 2, 1),
('9781594480003', 'The Secret Life of Bees', 'Sue Monk Kidd', 'Fiction', 2002, 'Penguin Books', 2, 2, 0, 2),
('9780553382575', 'The Alchemist', 'Paulo Coelho', 'Fantasy', 1988, 'HarperOne', 4, 4, 1, 3),
('9780385722205', 'The Lovely Bones', 'Alice Sebold', 'Fiction', 2002, 'Back Bay Books', 3, 3, 0, 4),
('9780307387899', 'The Help', 'Kathryn Stockett', 'Historical Fiction', 2009, 'Penguin Books', 5, 5, 1, 5),
('9780743273565', 'The Catcher in the Rye', 'J.D. Salinger', 'Fiction', 1951, 'Little, Brown and Company', 4, 4, 0, 1),
('9780061122412', 'Slaughterhouse-Five', 'Kurt Vonnegut', 'Science Fiction', 1969, 'Dell Publishing', 3, 3, 1, 2),
('9780140187393', 'One Day in the Life of Ivan Denisovich', 'Aleksandr Solzhenitsyn', 'Historical Fiction', 1962, 'Penguin Classics', 2, 2, 0, 3),
('9780765377069', 'Neuromancer', 'William Gibson', 'Science Fiction', 1984, 'Ace Books', 3, 3, 1, 4),
('9780143039477', 'The Grapes of Wrath', 'John Steinbeck', 'Historical Fiction', 1939, 'Penguin Classics', 4, 4, 0, 5),
('9780061120081', 'Lord of the Flies', 'William Golding', 'Fiction', 1954, 'Perigee Books', 3, 3, 1, 1),
('9780451524939', 'The Road Not Taken', 'Robert Frost', 'Poetry', 1916, 'Signet Classics', 5, 5, 2, 2),
('9780141187761', 'The Picture of Dorian Gray', 'Oscar Wilde', 'Fiction', 1890, 'Penguin Classics', 4, 4, 1, 3),
('9780064407663', 'Charlotte''s Web', 'E.B. White', 'Children''s Literature', 1952, 'HarperCollins', 3, 3, 0, 4),
('9780142437230', 'The Odyssey', 'Homer', 'Epic Poetry', -800, 'Penguin Classics', 5, 5, 1, 5),
('9780060935463', 'The Sun Also Rises', 'Ernest Hemingway', 'Fiction', 1926, 'Scribner', 2, 2, 0, 1),
('9780399501487', 'The Stand', 'Stephen King', 'Horror', 1978, 'Anchor Books', 4, 4, 1, 2),
('9780345413351', 'A Game of Thrones', 'George R.R. Martin', 'Fantasy', 1996, 'Bantam Books', 5, 5, 0, 3),
('9780553573404', 'Ender''s Game', 'Orson Scott Card', 'Science Fiction', 1985, 'Tor Books', 3, 3, 1, 4),
('9780062315007', 'The Fault in Our Stars', 'John Green', 'Young Adult', 2012, 'Dutton Books', 2, 2, 0, 5),
('9780446310789', 'The Old Man and the Sea', 'Ernest Hemingway', 'Fiction', 1952, 'Scribner', 4, 4, 1, 1);
