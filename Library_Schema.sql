...
INSERT INTO LibraryBooks (ISBN, Title, Author, Genre, Publication_Year, Publisher, Copies_Available, Total_Copies, Checked_Out) VALUES
('9780061120080', 'To Kill a Mockingbird', 'Harper Lee', 'Fiction', 1960, 'HarperCollins', 5, 5, 2),
('9781984819191', '1984', 'George Orwell', 'Science Fiction', 1949, 'Penguin Books', 3, 3, 0),
('9780060935462', 'The Catcher in the Rye', 'J.D. Salinger', 'Fiction', 1951, 'Little, Brown and Company', 4, 4, 1),
('9781400031363', 'One Flew Over the Cuckoo''s Nest', 'Ken Kesey', 'Fiction', 1962, 'Penguin Classics', 2, 2, 0),
('9780679783264', 'The Great Gatsby', 'F. Scott Fitzgerald', 'Fiction', 1925, 'Vintage Books', 2, 4, 2),
('9780380002935', 'To the Lighthouse', 'Virginia Woolf', 'Fiction', 1927, 'Doubleday', 2, 3, 1),
('9780765377066', 'Dune', 'Frank Herbert', 'Science Fiction', 1965, 'Ace Books', 3, 4, 1),
('9780345803507', 'Gone with the Wind', 'Margaret Mitchell', 'Historical Fiction', 1936, 'Vintage Books', 2, 2, 0),
('9780143039958', 'Middlemarch', 'George Eliot', 'Fiction', 1871, 'Penguin Classics', 3, 4, 1),
('9780553418020', 'The Martian', 'Andy Weir', 'Science Fiction', 2011, 'Broadway Books', 5, 5, 0),
('9780060929873', 'One Hundred Years of Solitude', 'Gabriel Garcia Marquez', 'Magical Realism', 1967, 'Harper & Row', 4, 5, 1),
('9780451524932', 'Fahrenheit 451', 'Ray Bradbury', 'Science Fiction', 1953, 'Del Rey Books', 3, 4, 1),
('9780380002934', 'The Metamorphosis', 'Franz Kafka', 'Fiction', 1915, 'Doubleday', 4, 4, 0),
('9780765377068', 'The Time Machine', 'H.G. Wells', 'Science Fiction', 1895, 'Ace Books', 3, 4, 1),
('9780140445863', 'Crime and Punishment', 'Fyodor Dostoevsky', 'Fiction', 1866, 'Penguin Classics', 3, 4, 1),
('9780192835467', 'Pride and Prejudice', 'Jane Austen', 'Fiction', 1813, 'Oxford University Press', 4, 5, 1),
('9780385515043', 'The Da Vinci Code', 'Dan Brown', 'Thriller', 2003, 'Doubleday', 3, 3, 0),
('9780062024028', 'The Hunger Games', 'Suzanne Collins', 'Young Adult', 2008, 'Scholastic', 3, 4, 1),
('9780451524934', 'Moby-Dick', 'Herman Melville', 'Fiction', 1851, 'Signet Classics', 2, 3, 1),
('9780345803509', 'The Hobbit', 'J.R.R. Tolkien', 'Fantasy', 1937, 'Houghton Mifflin', 4, 4, 2),
('9780765377063', 'Brave New World', 'Aldous Huxley', 'Science Fiction', 1932, 'Harper & Brothers', 2, 3, 1),
('9780143039955', 'War and Peace', 'Leo Tolstoy', 'Historical Fiction', 1869, 'Penguin Classics', 3, 4, 2),
('9780553418025', 'The Road', 'Cormac McCarthy', 'Post-Apocalyptic', 2006, 'Vintage Books', 4, 5, 1),
('9780060929875', 'The Lord of the Rings', 'J.R.R. Tolkien', 'Fantasy', 1954, 'Houghton Mifflin', 5, 5, 1),
('9780451524938', 'The Shining', 'Stephen King', 'Horror', 1977, 'Anchor Books', 2, 3, 0);
